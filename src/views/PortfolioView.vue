    ...
    <section id="portfolio-wrapper">
        ...
        <div id="portfolio-card-section">
            <div class="project-card" v-for="project in projects" :key="project.id">
                <picture>
                    <source :srcset="`https://strapi-z4iu.onrender.com` + project.Carre.url" media="(min-width: 1320px)">
                    <source :srcset="`https://strapi-z4iu.onrender.com` + project.Rectangle.url" media="(min-width: 1150px)">
                    <source :srcset="`https://strapi-z4iu.onrender.com` + project.Carre.url" media="(min-width: 1000px)">
                    <img :src="`https://strapi-z4iu.onrender.com` + project.Carre.url" alt="MDN">
                </picture>
            </div>
        </div>
        <div id="back-to-top">
