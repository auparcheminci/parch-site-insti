...
onMounted(async () => {
  try {
    const res = await axios.get('https://strapi-z4iu.onrender.com/api/main-office-catalogs?populate=*', {
      headers: {
...
<template>
    <div id="main-catalog-office-wrapper">
        <div class="main-catalog-inside" v-for="catalogue in catalogues" :key="catalogue.id">
            ...
            <div class="links">
                <div class="link-main">
                    <a v-if="catalogue.document_mob" :href="`https://strapi-z4iu.onrender.com${catalogue.document_mob.url}`" target="_blank">Chaises & bureaux
